...
def main():
    ...
    while True:
        ...
        try:
            ...
            # Split the received data string and convert the parts into integers
        ...
        light_level = min(100, light_level + 0.0001 * light)
        water_level = min(100, water_level + 0.1 * (50 - water))
